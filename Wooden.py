...
---------------------------------------------------- Link for the challenge: https://codeforces.com/problemset/problem/1197/A -----------------------------------
...
For example, ladders 1 and 3 are correct 2-step ladders and ladder 2 is a correct 1-step ladder. 
On the first picture the lengths of planks are [3,3] for the base and [1] for the step. On the second picture lengths are [3,3] for the base and [2] for the step. 
On the third picture lengths are [3,4] for the base and [2,3] for the steps.


You have n planks. The length of the i-th planks is ai. 
...
The second line contains n integers a1,a2,…,an (1 ≤ ai ≤ 10^5) — the lengths of the corresponding planks.
...
for _ in range(cases):
    ...
    left = arr[-1]
    right = arr[-2]
    print(min((sze - 2), (min(left, right) - 1)))