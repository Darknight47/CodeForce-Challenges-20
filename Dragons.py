...
----------------------------------------- Link for the challenge: https://codeforces.com/problemset/problem/230/A -----------------------------------------
...
Input
The first line contains two space-separated integers s and n (1 ≤ s ≤ 104, 1 ≤ n ≤ 10^3). 
Then n lines follow: the i-th line contains space-separated integers xi and yi (1 ≤ xi ≤ 10^4, 0 ≤ yi ≤ 10^4) — the i-th dragon's strength and the bonus for defeating it.
...
ok = True
for temp_idx, temp_strength in sorted_dict:
    if(s > temp_strength):
        s += arr[temp_idx]
    else:
        ok = False
